...
namespace Microsoft.Xna.Framework
{
    ...
    public struct OwnRectangle : IEquatable<OwnRectangle>
    {
        ...
        public OwnRectangle(Point location, Point size)
        {
            this.X = location.X;
            this.Y = location.Y;
            this.Width = size.X;
        ...
        public static bool operator ==(OwnRectangle a, OwnRectangle b)
        {
        ...
        {
            return (obj is Rectangle) && this == ((OwnRectangle)obj);
        }
        ...
        /// <returns><c>true</c> if the instances are equal; <c>false</c> otherwise.</returns>
        public bool Equals(OwnRectangle other)
        {
            return this == other;
        }
        ...
        public bool Intersects(OwnRectangle value)
        {
        ...
        public void Intersects(ref OwnRectangle value, out bool result)
        {
        ...
        public static OwnRectangle Intersect(OwnRectangle value1, OwnRectangle value2)
        {
            OwnRectangle rectangle;
        ...
        public static void Intersect(ref OwnRectangle value1, ref OwnRectangle value2, out OwnRectangle result)
        {
            if (value1.Intersects(value2))
            {
                ...
                result = new OwnRectangle(left_side, top_side, right_side - left_side, bottom_side - top_side);
            }
            else
            {
                result = new OwnRectangle(0, 0, 0, 0);
            }
        }
